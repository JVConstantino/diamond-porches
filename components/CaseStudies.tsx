        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Explore our portfolio of successful projects and see the quality craftsmanship we deliver.
            </p>
          </div>
              ...
              >
                <div className="relative">
                  <a href={`/#/case-study/${study.id}`}>
                    <img src={study.mainImage} alt={study.title} className="w-full h-56 object-cover" />
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <p className="text-sm text-brand-blue-600 font-semibold uppercase tracking-wide">{study.projectType.replace('_',' ')}</p>
                  <h3 className="mt-2 text-xl font-bold text-gray-800">{study.title}</h3>
