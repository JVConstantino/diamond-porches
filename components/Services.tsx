...
const ServiceCard: React.FC<{ service: Service }> = ({ service }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full">
            ...
            <h4 className="text-lg font-semibold text-brand-blue-900 mb-2">{t(`service.${service.icon}.name`)}</h4>
            <p className="text-gray-600 text-sm">{t(`service.${service.icon}.description`)}</p>
        </div>
    );
};
                ...
                <div className="mt-12 space-y-12">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-brand-blue-800 mb-6 text-center sm:text-left">
                           {t('services.screenedPorch.title')}
                        </h3>
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-brand-blue-800 mb-6 text-center sm:text-left">
                            {t('services.otherExterior.title')}
                        </h3>
                         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
